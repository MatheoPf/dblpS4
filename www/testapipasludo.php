...
$nom_auteur_formatte = str_replace(' ', '_', $nom_auteur); // Remplace les espaces par _
$lien = "https://dblp.org/search/publ/api?q=author%3A" . urlencode($nom_auteur_formatte) . "%3A&format=json";


$publi = file_get_contents($lien);
